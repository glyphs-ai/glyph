/**
 * Runtime-v2 error atoms — discriminated-union values flowing through
 * `Result`, not thrown exceptions. Adapters translate any underlying
 * driver/CLI fault into one of these; `cause` carries the original for
 * server-side logging and stays off the wire.
 */
