...
// thresholds" recipe: build a `__Entity__ServiceCtx` once in the constructor, then each
// public method is a single `return delegate(this.ctx, …args)` line. Stays well under
// the 250 LOC facade ceiling from `docs/pkg-template.md § Hard rules` rule #6.
