...
export function workspacesRoutes(application: Application): OpenAPIHono {
  ...
  app.openapi(
    createRoute({
      ...
      responses: {
        200: jsonResponse(WorkspaceSummarySchema.array(), "Registered workspaces"),
  ...
  app.openapi(
    createRoute({
      ...
      request: {
        body: { content: { "application/json": { schema: CreateWorkspaceRequestSchema } } },
      },
      responses: {
        201: jsonResponse(WorkspaceSummarySchema, "Created workspace"),
  ...
  app.openapi(
    createRoute({
      ...
      request: {
        body: { content: { "application/json": { schema: SetCurrentWorkspaceRequestSchema } } },
      },
      responses: {
  ...
  app.openapi(
    createRoute({
      ...
      responses: {
        200: jsonResponse(WorkspaceSummarySchema, "Workspace"),
        404: errorResponse("Workspace not registered"),
        500: errorResponse("Internal error"),
      },
    }),
  ...
  app.openapi(
    createRoute({
      ...
      request: {
        ...
        body: { content: { "application/json": { schema: PatchWorkspaceRequestSchema } } },
      },
      responses: {
        200: jsonResponse(WorkspaceSummarySchema, "Updated workspace"),
        400: errorResponse("Malformed request body"),
        404: errorResponse("Workspace not registered"),
        500: errorResponse("Internal error"),
      },
