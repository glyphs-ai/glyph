...
export { type DiffOptions, type DiffResult, diffClosures } from "./resolve-pipeline/diff.js";
export { buildLocalClosure } from "./resolve-pipeline/local.js";
export type {
  Closure,
  ClosureNode,
  ClosureSource,
  PipelineServices,
} from "./resolve-pipeline/types.js";
export {
  buildUpstreamClosure,
  type UpstreamClosureOpts,
  type UpstreamClosureResult,
} from "./resolve-pipeline/upstream.js";
