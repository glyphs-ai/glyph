import type { Skill } from "../contract/catalog.types.js";
import {
  depsToJSON,
  emptyDeps,
  emptyOriginDeps,
...
import { makeFqn, splitFqn, validateFqn } from "./skill.schemas.js";
...
export class SkillEntity {
  ...
  static create(rawSkillMd: string, origin: Origin, sourceLabel: string): SkillEntity {
