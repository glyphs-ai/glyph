import type { Agent } from "../contract/catalog.types.js";
import {
  AGENT_DEP_SPECS,
  type AgentDepKind,
...
import { makeFqn, splitFqn, validateFqn } from "./agent.schemas.js";
import {
  depsToJSON,
  emptyDeps,
  emptyOriginDeps,
...
export class AgentEntity {
  ...
  static create(rawAgentMd: string, origin: Origin, sourceLabel: string): AgentEntity {
