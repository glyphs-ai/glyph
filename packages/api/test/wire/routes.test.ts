...
const EXPECTED_ROUTES: ReadonlyArray<readonly [RouteKey, string]> = [
  ...
  ["catalog.skills.get", "GET /api/workspaces/:id/catalog/skills/:scope/:name"],
  ["catalog.skills.anchor.get", "GET /api/workspaces/:id/catalog/skills/:scope/:name/anchor"],
  ["catalog.skills.install", "POST /api/workspaces/:id/catalog/skills"],
  ["catalog.skills.delete", "DELETE /api/workspaces/:id/catalog/skills/:scope/:name"],
  [
    "catalog.skills.sync.resolve",
    "POST /api/workspaces/:id/catalog/skills/:scope/:name/sync/resolve",
  ],
  ["catalog.skills.sync", "POST /api/workspaces/:id/catalog/skills/:scope/:name/sync"],
  [
    "catalog.skills.prereqs.acknowledge",
    "POST /api/workspaces/:id/catalog/skills/:scope/:name/acknowledge-prereqs",
  ],
  ["catalog.skills.files.list", "GET /api/workspaces/:id/catalog/skills/:scope/:name/files"],
  ...
  ["catalog.agents.get", "GET /api/workspaces/:id/catalog/agents/:scope/:name"],
  ["catalog.agents.anchor.get", "GET /api/workspaces/:id/catalog/agents/:scope/:name/anchor"],
  ["catalog.agents.install", "POST /api/workspaces/:id/catalog/agents"],
  ["catalog.agents.delete", "DELETE /api/workspaces/:id/catalog/agents/:scope/:name"],
  [
    "catalog.agents.sync.resolve",
    "POST /api/workspaces/:id/catalog/agents/:scope/:name/sync/resolve",
  ],
  ["catalog.agents.sync", "POST /api/workspaces/:id/catalog/agents/:scope/:name/sync"],
  [
    "catalog.agents.prereqs.acknowledge",
    "POST /api/workspaces/:id/catalog/agents/:scope/:name/acknowledge-prereqs",
  ],
  ["catalog.agents.disable", "POST /api/workspaces/:id/catalog/agents/:scope/:name/disable"],
  ["catalog.agents.enable", "POST /api/workspaces/:id/catalog/agents/:scope/:name/enable"],
  ["catalog.agents.files.list", "GET /api/workspaces/:id/catalog/agents/:scope/:name/files"],
  ["catalog.mcps.list", "GET /api/workspaces/:id/catalog/mcps"],
  ["catalog.mcps.get", "GET /api/workspaces/:id/catalog/mcps/:scope/:name"],
  ["catalog.mcps.install", "POST /api/workspaces/:id/catalog/mcps"],
  ["catalog.mcps.delete", "DELETE /api/workspaces/:id/catalog/mcps/:scope/:name"],
  ["catalog.mcps.sync.resolve", "POST /api/workspaces/:id/catalog/mcps/:scope/:name/sync/resolve"],
  ["catalog.mcps.sync", "POST /api/workspaces/:id/catalog/mcps/:scope/:name/sync"],
];
