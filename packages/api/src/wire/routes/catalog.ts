...
/**
 * POST /api/workspaces/:id/catalog/{kind}/:scope/:name/sync body. The
...
/** GET /api/workspaces/:id/catalog/skills/:scope/:name response (entry + content). */
export type SkillWithContent = SkillEntry & { readonly content: string };

/** GET /api/workspaces/:id/catalog/agents/:scope/:name response. */
export type AgentWithContent = AgentEntry & { readonly content: string };

/** GET /api/workspaces/:id/catalog/{agents,skills}/:scope/:name/anchor response. */
export interface AnchorResponse {
  readonly content: string;
}

/** GET /api/workspaces/:id/catalog/mcps/:scope/:name response. */
...
/** Catalog-resource path params (skills / agents / mcps). The fully-qualified
 * name splits into a `scope` segment and a single-segment short `name`. */
...
export const catalogRoutes = {
  ...
  "catalog.skills.get": defineRoute<{ params: CatalogResourcePathParams }, SkillWithContent>(
    "GET",
    "/api/workspaces/:id/catalog/skills/:scope/:name",
  ),
  "catalog.skills.anchor.get": defineRoute<{ params: CatalogResourcePathParams }, AnchorResponse>(
    "GET",
    "/api/workspaces/:id/catalog/skills/:scope/:name/anchor",
  ),
  ...
  "catalog.skills.sync": defineRoute<
    ...
    CatalogSyncResult
  >("POST", "/api/workspaces/:id/catalog/skills/:scope/:name/sync"),
  "catalog.skills.prereqs.acknowledge": defineRoute<{ params: CatalogResourcePathParams }, Skill>(
    "POST",
    "/api/workspaces/:id/catalog/skills/:scope/:name/acknowledge-prereqs",
  ),
  "catalog.skills.files.list": defineRoute<
    { params: CatalogResourcePathParams },
    CatalogFileEntry[]
  >("GET", "/api/workspaces/:id/catalog/skills/:scope/:name/files"),
  ...
  "catalog.agents.get": defineRoute<{ params: CatalogResourcePathParams }, AgentWithContent>(
    "GET",
    "/api/workspaces/:id/catalog/agents/:scope/:name",
  ),
  "catalog.agents.anchor.get": defineRoute<{ params: CatalogResourcePathParams }, AnchorResponse>(
    "GET",
    "/api/workspaces/:id/catalog/agents/:scope/:name/anchor",
  ),
  ...
  "catalog.agents.sync": defineRoute<
    { params: CatalogResourcePathParams; body: SyncCatalogRequest },
    CatalogSyncResult
  >("POST", "/api/workspaces/:id/catalog/agents/:scope/:name/sync"),
  "catalog.agents.prereqs.acknowledge": defineRoute<{ params: CatalogResourcePathParams }, Agent>(
    "POST",
    "/api/workspaces/:id/catalog/agents/:scope/:name/acknowledge-prereqs",
  ),
  "catalog.agents.disable": defineRoute<{ params: CatalogResourcePathParams }, Agent>(
    "POST",
    "/api/workspaces/:id/catalog/agents/:scope/:name/disable",
  ),
  "catalog.agents.enable": defineRoute<{ params: CatalogResourcePathParams }, Agent>(
    "POST",
    "/api/workspaces/:id/catalog/agents/:scope/:name/enable",
  ),
  "catalog.agents.files.list": defineRoute<
    { params: CatalogResourcePathParams },
    CatalogFileEntry[]
  >("GET", "/api/workspaces/:id/catalog/agents/:scope/:name/files"),
  ...
  "catalog.mcps.get": defineRoute<{ params: CatalogResourcePathParams }, McpWithContent>(
    "GET",
    "/api/workspaces/:id/catalog/mcps/:scope/:name",
  ),
  ...
  "catalog.mcps.sync.resolve": defineRoute<{ params: CatalogResourcePathParams }, ResolveManifest>(
    "POST",
    "/api/workspaces/:id/catalog/mcps/:scope/:name/sync/resolve",
  ),
  "catalog.mcps.sync": defineRoute<
    { params: CatalogResourcePathParams; body: SyncCatalogRequest },
    CatalogSyncResult
  >("POST", "/api/workspaces/:id/catalog/mcps/:scope/:name/sync"),
