...
3. **Consult the agency role library** for a starting template — workflow: see `references/hiring/writing-good-agent-prompts.md#agency-role-library`. If no upstream role fits, skip and draft from scratch via the references in step 4.
